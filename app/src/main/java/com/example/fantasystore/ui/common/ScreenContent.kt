...
import com.example.fantasystore.ui.navigation.BottomNavigationItem
...
fun AppBottomNavigation(navController: NavHostController, items: List<BottomNavigationItem>) {
    ...
    // Obtén el color primario de tu tema
    val primaryColor = MaterialTheme.colorScheme.tertiary

    // Aplica el color a la barra de navegación del dispositivo
...
fun AppBottomNavigationPreview() {
    ...
    FantasyStoreTheme { AppBottomNavigation(navController, bottomNavigationItems) }
}
