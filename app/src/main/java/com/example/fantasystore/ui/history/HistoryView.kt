...
import com.example.fantasystore.domain.topFrankfurterWorldCurrencies
import com.example.fantasystore.ui.common.GenericErrorView
import com.example.fantasystore.ui.common.ScreenContent
import com.example.fantasystore.ui.home.CurrencyInfoRow
import com.example.fantasystore.ui.home.CurrencySelectionDialog
        ...
        WebView(context).apply {
            ...
            loadDataWithBaseURL(
                ...
                """
                    <html>
                    <body>
                        <button onclick="sayHello()">Say Hello from JS</button>
                        <script>
                            function sayHello() {
